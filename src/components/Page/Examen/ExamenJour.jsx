      ...
      <div className="card">
        <TabView activeIndex={activeIndex} onTabChange={(e)=>{ setActiveIndex(e.index) }} >
          <TabPanel header="Patient à examiner"   >
            <ExamenNonEff url={props.url}  activeIndex={activeIndex} setActiveIndex={setActiveIndex} />
          </TabPanel>
          ...
          <TabPanel header="Patient examiné">
            <ExamenEffValide url={props.url}  activeIndex={activeIndex} setActiveIndex={setActiveIndex} />
          </TabPanel>
        </TabView>
      </div>
    </div>
