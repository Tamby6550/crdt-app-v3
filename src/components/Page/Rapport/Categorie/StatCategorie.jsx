...
export default function StatCategorie(props) {
    ...
    const loadData = async () => {
        await axios.post(props.url + `getStatCategorie`,
            {
    ...
    return (
        <>
            <Dialog header={'STAT CATEGORIE'} visible={displayBasic2} className="lg:col-3 md:col-3 col-8 p-0" onHide={() => onHide('displayBasic2')}  >
                                ...
                                Array.from({ length: nombreDePages }, (_, index) => {
                                    ...
                                    return (
                                        <div key={index} className='rapportxxx'>
                                            <span class="Style2" style={{ fontWeight: "bold" }}>
                                                CRDT
                                            </span>
                                            <table width="488" border="0" align="center">
                                                <tr>
                                                    <td width="449">
                                                        <strong>STATISTIQUE DES CATEGORIES du </strong>
                                                ...
                                                {pagededonnees.map((el, i) => (
                                                    <tr key={i}>
                                                        <td width="220" class="table" align="left">
                                                            <font size="1">{el.type_client}</font>
                                                        </td>
                                                        <td width="186" class="table" align="justify">
                                                            <div align="right">
                                                                <font size="1"> {el.nombre}</font>
                                                            </div>
                                                        </td>
                                                        <td width="141" class="table" align="justify">
                                                            <div align="right">
                                                                <font size="1">
                                                                    {" "}
                                                                    {pourcentage(el.nombre, DataAll.nombre)}
                                                                </font>
                                                            </div>
                                                        </td>
