...
export default function ChoixClient(props) {
    ...
    return (
        <>
            ...
            <Button disabled={props.typeclient=='L2'?true:false} icon={PrimeIcons.SEARCH} className={props.typeclient=='a'? 'p-buttom-sm p-3 mr-2  p-button-info ':'p-buttom-sm p-1 mr-2  p-button-secondary '} tooltip={props.typeclient=='a'? '':'Choisir'} tooltipOptions={{ position: 'top' }} onClick={() => { onClick('displayBasic2'); chargementData() }} />
