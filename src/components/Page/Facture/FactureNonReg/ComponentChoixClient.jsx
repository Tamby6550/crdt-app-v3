...
export default function ComponentChoixClient(props) {
    ...
    return (
        <>
            ...
            <Button  icon={PrimeIcons.SEARCH} style={{height:'25px'}} className={'p-buttom-sm p-3 mr-2  p-button-info '} tooltip={'Choisir le client'} tooltipOptions={{ position: 'top' }} onClick={() => { onClick('displayBasic2'); chargementData() }} />
